...
<div className="container-fluid">
    <div className="row "> {/* ✅ makes both columns level */}
      ...
      <div className="col-lg-4  text-lg-start text-center">
        ...
        <div className='flex items-center justify-center '>
         ...
         style={{objectFit:'contain'}} >
          <img src={playstore} alt='playstoreimg' width={180} className=" object-contain" /></a>
           {/* App store */}
          ...
          style={{objectFit:'contain'}} >
          <img src={apple} alt='appleimg' width={180} className=" object-contain"/></a>
          </div>
      ...
      {/* Right Column */}
      <div className="col-lg-4 mt-3 text-lg-end flex flex-column justify-space-between text-center text-white ">  
        <div className='customtext'>
          ...
          <p className=" text-white  customtext">ALL RIGHTS RESERVED</p>
